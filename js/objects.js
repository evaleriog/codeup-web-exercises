(function() {
    ...
    shoppers.forEach(function (shopper) {
        ...
        console.log("Name: " + shopper.name + " | Amount Before: " + shopper.amount + " | Discount: "
        + discount + " | Price after discount: " + (shopper.amount - (shopper.amount * discount)));
    });
    ...
    myBooks.push(createBook("The Da Vinci Code", "Dan Brown"));
    myBooks.push(createBook("The Alchemist", "Paulo Coehlo"));
