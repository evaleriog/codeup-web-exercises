$(document).ready(function(){
     ...
     */
    //$.ajax("https://hookb.in/oX1VLYJ2OJiGzYlyPjVl?username=Bob");
    ...
    //console.log($.ajax("https://hookb.in/oX1VLYJ2OJiGzYlyPjVl", person));
    ...
    // console.log($.ajax("https://hookb.in/oX1VLYJ2OJiGzYlyPjVl", {
    //     type: "GET",
    //     data: {
    //         username: "bob",
    ...
    var starWars = $.ajax("https://swapi.co/api/films").done(function (data) {
        console.log(data);
    });
    ...
    newHope.done(function (data) {
        console.log("Director of A New Hope is: " + data.results[0].director);
    });
    /*
    ...
    forceAwakens.done(function (data) {
        console.log("Release date for The Force Awakens: " + data.results[0].release_date);
    });
    ...
    var canterbury = $.ajax("./data/books.json");

    canterbury.done(function (data) {
        console.log("The author of The Canterbury Tales is " + data[17].author);
    });

    canterbury.fail(function () {
       console.log("Check path to books...");
    });
    ...
    function generateBooks(){
        ...
        requestBooks.fail(function () {
            console.log("Check the path of JSON file");
        });
    }
