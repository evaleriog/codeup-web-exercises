...
var profileReport = {
    ...
    sumOfAllBalances: function () {
        ...
        profiles.forEach(function (profile) {
            var profileBalance = profile.balance.replace(/[^\d.]/g, '');
            totalBalances = totalBalances + parseFloat(profileBalance);
        });
...
console.log("Total of Profiles: " + profileReport.getProfileCount());
