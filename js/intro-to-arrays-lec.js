...
var favoriteFoods = ["pizza", "tacos", "italian", "seafood"];
...
console.log("Length of daysOfTheWeek array: " + daysOfTheWeek.length);
// TODO: console.log the length of the favoriteFoods array
console.log("Length of favoriteFoods array: " + favoriteFoods.length);
...
for(var i = 0; i < shapes.length; i++){
    if(shapes[i] === "circle"){
        alert(shapes[i] + " its my favorite shape");
    }
}
...
for(var x = 0; x < instructors.length; x++){
    if(instructors[x] === "sophie" || instructors[x]==="david" || instructors[x] === "vivian" || instructors[x] === "justin"){
        alert("Hey, I know " + instructors[x]);
    }
    else {
        alert("I have not had class with " + instructors[x]);
    }
}
